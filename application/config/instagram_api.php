...
$config['instagram_callback_url']	= 'http://localhost/qubikal/home/loginresult';//e.g. http://yourwebsite.com/authorize/get_code/
$config['instagram_website']		= 'http://localhost/qubikal/';//e.g. http://yourwebsite.com/
