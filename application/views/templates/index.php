...
<header>
	<div class="container top-sect">
		<div class="container" style="text-align: center; padding: 30px;">
			...
			<a href="<?php echo base_url().'index.php/home/index' ?>"><img
				src="<?php echo base_url()?>assets/images/icon/logo.png" alt="logo"
				style="width: 6%;"></a>
		</div>
	</div>
</header>
...
<main>        
	...
	data-url="images/parallax1.jpg" data-mobile="
      true"
	data-speed="0.9">
	<div class="container">
        ...
        <?php
          ...
          <div class="wrap text-center">
			<a href="<?php echo base_url().'index.php/home/search' ?>"
				class="btn btn-primary">Search </a> <a
				href="<?php echo base_url()?>" class="btn btn-active">Home </a>
		</div>
	</div>
</section>
<style type="text/css">
